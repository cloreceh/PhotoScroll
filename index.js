ScrollReveal().reveal('.stonehaven', { 
    duration: 500, 
    easing: 'ease-in',
    reset: true,
    viewFactor: 0.9,
  ...
  ScrollReveal().reveal('.castleGrounds', { 
    duration: 500, 
    easing: 'ease-in',
    reset: true,
    viewFactor: 0.9,
